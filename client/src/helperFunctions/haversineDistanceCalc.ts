...
export default function haversineDistance(coord1: PointLngLat, coord2: PointLngLat, distanceMeasure: string): number {
  ...
  throw new Error("The measure must be km or miles") //
}